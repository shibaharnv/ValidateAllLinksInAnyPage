package linkscheck;// Import necessary packages
...
public class BrokenImagesTestCompleteDOM2 {
            ...
            for (Map.Entry<Object, Object> entry : properties.entrySet()) {
                ...
                for (WebElement iframe : iframes) {
                    ...
                    if (iframeBrokenImagesCount > 0) {
                        String uniqueRowKey = applicationName + applicationUrl + iframeBrokenImagesCount;
                        if (uniqueRows.add(uniqueRowKey)) {
                            ImageStatusReporter(writer, applicationName, applicationUrl, iframeBrokenImagesCount, getBrokenImagesList(iframeImagesArray));
                        }
                    }
